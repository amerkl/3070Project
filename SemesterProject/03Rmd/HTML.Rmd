...
Considering the personal investment most people have with their sports team, it's not far off to say that some of their actions may be affected based on the outcome of a game. The chart below shows how crimes numbers and types of crimes are affected based on the outcome of LSU games. As you can see, crimes actually increase based on if LSU wins, more specificially in the other and Theft categories. This shows how LSU events can influence individuals to potentially act out of their normal attitudes.
